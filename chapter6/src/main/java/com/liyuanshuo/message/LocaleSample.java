...
public class LocaleSample {
    ...
    private static void messageFormat1() {
    ...
    private static void resourceBoundle(){
        ResourceBundle rb1 = ResourceBundle.getBundle("com/liyuanshuo/message/resource",Locale.US);
        ResourceBundle rb2 = ResourceBundle.getBundle("com/liyuanshuo/message/resource",Locale.CANADA);
        System.out.println("us:"+rb1.getString("greeting.common"));
        System.out.println("cn:"+rb2.getString("greeting.common"));
    }

    private static void resourceBoundleFmt(){
        ResourceBundle rb1 = ResourceBundle.getBundle("com/liyuanshuo/message/fmt_resource",Locale.US);
        ResourceBundle rb2 = ResourceBundle.getBundle("com/liyuanshuo/message/fmt_resource",Locale.CHINA);
