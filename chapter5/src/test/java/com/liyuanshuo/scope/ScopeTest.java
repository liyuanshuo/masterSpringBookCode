 ...
 */
@ContextConfiguration("classpath*:com/liyuanshuo/scope/beans.xml")
public class ScopeTest extends AbstractTestNGSpringContextTests {
    ...
    public void testGetBean(){
        assertNotSame(applicationContext.getBean("car", Car.class), applicationContext.getBean("car", Car.class));
    }
}
