...
public class ObjectExprSample {
    ...
    public static void main(String[] args) {
        ...
        user = parser.parseExpression("new com.cqu.User('tom')").getValue(User.class);
        ...
        Class userClass=parser.parseExpression("T(com.cqu.User)").getValue(Class.class);
        System.out.println(dateClass==java.util.Date.class);
        System.out.println(stringClass==java.lang.String.class);
        System.out.println(userClass == com.cqu.User.class);
